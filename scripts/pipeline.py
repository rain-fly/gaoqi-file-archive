...
class PipelineOrchestrator:
    ...
    def __init__(self,
                 input_dir: str,
                 output_dir: str,
                 ollama_url: str = "http://192.168.1.26:11001",
...
示例:
  ...
  # 指定 Ollama 地址和模型
  python scripts/pipeline.py -i ./客户原始数据 -o ./整理结果 --ollama-url http://192.168.1.26:11001 --model qwen3.5:0.8b
  ...
  python scripts/pipeline.py -i ./客户原始数据 -o ./整理结果 --no-skip-existing
    ...
    parser.add_argument("-o", "--output", required=True,
                        help="输出目录（分类整理后的文件）")
    parser.add_argument("--ollama-url", default="http://192.168.1.26:11001",
                        help="Ollama 服务地址 (默认: http://192.168.1.26:11001)")
